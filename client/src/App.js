      ...
      <ScrollReveal
        ...
        children={() => (
          <Switch>
            ...
            <AppRoute exact path="/events" component={Events} layout={LayoutDefault} user={user} state={state} events={events}/>
            <AppRoute exact path="/events/:event" component={EventDetails} layout={LayoutDefault} events={events} toast={showToast} />
